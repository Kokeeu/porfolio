...
const CASOS = {
  siwo: {
    ...
    resumen: 'Buscador de openings y endings de anime con 586+ entradas, filtros por temporada y un índice regenerado automáticamente.',
    ...
    resultados: ['586+ entradas', 'Cobertura 1999–2026', 'Actualización automática'],
    stack: ['Astro', 'React', 'Tailwind CSS', 'GitHub Actions'],
    metrica: '586+',
    etiquetaMetrica: 'TÍTULOS INDEXADOS',
